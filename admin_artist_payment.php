...
<section class="user-table">
   <table>
      ...
      <tbody>
         <?php
            $res = mysqli_query($conn, "SELECT a.id,a.user_id,p.name,p.price,a.final_price,a.placed_on,a.status FROM artist_payment a INNER JOIN products p ON a.name=p.name") or die('query failed');
         ...
         <tr>
            ...
            <td id="remove">
               <a id="remove" href="admin_artist_payment.php?delete=<?php echo $row['id']; ?>" class="btnn" onclick="return confirm('remove this payment?');"> remove</a>
            </td>
         </tr>
